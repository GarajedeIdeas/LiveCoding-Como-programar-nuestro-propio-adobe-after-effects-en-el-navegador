...
const muxManifestUrl = (playbackId) => `https://stream.mux.com/${playbackId}.m3u8`;

const muxThumbnail = (playbackId, options = {}) =>
  `https://image.mux.com/${playbackId}/thumbnail.jpg${serializeQuerystring(options)}`;
...
if (Hls.isSupported()) {
  ...
  videos.forEach((video) => {
    ...
    video.setAttribute("poster", video.poster || muxThumbnail(playbackId, { time: posterTime }));
